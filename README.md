...
เอกสารสรุปขั้นตอนการตั้งค่าโปรเจกต์และการทดสอบคำสั่งต่างๆ สำหรับงาน HW-03-04 (Django Model) และ Wk02 (HttpRequest/HttpResponse) ร่วมกัน หรืออยากเล่น [API Wk02 คลิกดูตัวอย่างได้เลย](https://github.com/Wattanaroj2567/WebDev2568/tree/Week02)
